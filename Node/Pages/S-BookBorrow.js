...
function Template() {
    ...
    <div class="mt-2 text-center">
        ...
        <h5 class="pt-2 pb-2 text-center text-secondary">Issue Type</h5>
        <select class="custom-select bg-light mr-2 w-auto" id="borrowType" data-toggle="tooltip" data-placement="top" title="Select an issue type here">
