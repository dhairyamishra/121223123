...
router.get('/',function(req,res,next) {
    ...
    sessionMan.sessionIdValid(cookie, 3, function(err,valid) {
        ...
        if(valid) { 
            log.silly(JSON.stringify({msg:'get manager', sess: cookie}));
...
router.post('/logout',function(req,res,next) {
    ...
    sessionMan.sessionIdValid(cookie, 3, function(err,valid) {
        ...
        //If the client is valid redirect them to the appropiate page
        if(valid) { 
            log.silly(JSON.stringify({msg:'manager logout', sess: cookie}));
...
function Template() {
    ...
    <div class="mt-2">
        <h3 class="text-center">Logged in as a Library Manager</h3>
    </div>
    <br>
    <a class="btn btn-lg w-75 mb-2 mt-2 mx-auto btn btn-primary btn-block" href="/createbook" data-toggle="tooltip" data-placement="top" title="Click to go to book creation">Add a Book</a>
    <a class="btn btn-lg w-75 mb-2 mt-2 mx-auto btn btn-primary btn-block" href="/bookmanagement" data-toggle="tooltip" data-placement="top" title="Click to go to device maintenance">Maintain Books</a>
    <a class="btn btn-lg w-75 mb-2 mt-2 mx-auto btn btn-primary btn-block" href="/usermanagement" data-toggle="tooltip" data-placement="top" title="Click to go to user management">User Management</a>
    `;
